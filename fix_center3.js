...
// Replace Latest Vitals
latestVitals = latestVitals.replace(
  /<div className="flex items-center gap-2 mb-4">[\s\S]*?<h2 className="text-sm font-semibold uppercase tracking-wider">Latest Progress<\/h2>\s*<\/div>/,
