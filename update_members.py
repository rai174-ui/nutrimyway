...
old_broken_api = content[content.find('// GET /api/members/:id/checkin-menu'):content.find('// POST /api/members/:id/photo')]

members_api = '''// GET /api/members/:id/checkin-menu
...
if old_broken_api:
    content = content.replace(old_broken_api, members_api)
